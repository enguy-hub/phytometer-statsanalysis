...
#   + flo_abundance.yj, flo_richness, flo_shannon (not norm-dist)
...
fmmd.lm.s6 <- lm(fremass_meandiff ~ pol_abundance.yj, data=RA_data)
summary(fmmd.lm.s6) # RSE: 0.008 ; Adj-R2: -0.07 ; p:: 0.665 *
...
fmmd.lm.s9 <- lm(fremass_meandiff ~ flo_abundance.yj, data=RA_data)
summary(fmmd.lm.s9) # RSE: 0.008 ; Adj-R2: -0.08 ; p:: 0.854
...
fmmd.lm0 <- lm(fremass_meandiff ~ temp + lux + imperv1000 +
               pol_abundance.yj + pol_richness + pol_shannon + 
               flo_abundance.yj + flo_richness + flo_shannon, data=RA_data)
summary(fmmd.lm0) # Adj-R2: -1.962; p: 0.994
...
fmmo.lm.s6 <- lm(fremass_meanopen ~ pol_abundance.yj, data=RA_data)
summary(fmmo.lm.s6) # RSE: 0.009 ; Adj-R2: -0.06 ; p:: 0.596 *

fmmo.lm.s7 <- lm(fremass_meanopen ~ pol_richness, data=RA_data)
summary(fmmo.lm.s7) # RSE: 0.009 ; Adj-R2: -0.089 ; p:: 0.908

fmmo.lm.s8 <- lm(fremass_meanopen ~ pol_shannon, data=RA_data)
summary(fmmo.lm.s8) # RSE: 0.009 ; Adj-R2: -0.031 ; p:: 0.443 *

fmmo.lm.s9 <- lm(fremass_meanopen ~ flo_abundance.yj, data=RA_data)
summary(fmmo.lm.s9) # RSE: 0.009 ; Adj-R2: -0.08 ; p:: 0.852
...
# -- Create multiple regression lm() models ----
fmmo.lm0 <- lm(fremass_meanopen ~lux + imperv100 + #  temp + 
               pol_abundance.yj + pol_richness + pol_shannon + 
               flo_abundance.yj + flo_richness + flo_shannon, data=RA_data)
summary(fmmo.lm0) # Adj-R2: -0.15; p:: 0.9366
...
dmmd.lm.s6 <- lm(drymass_meandiff ~ pol_abundance.yj, data=RA_data)
summary(dmmd.lm.s6) # RSE: 0.0053 ; Adj-R2: -0.088 ; p:: 0.88
...
dmmd.lm.s9 <- lm(drymass_meandiff ~ flo_abundance.yj, data=RA_data)
summary(dmmd.lm.s9) # RSE: 0.0053 ; Adj-R2: -0.087 ; p:: 0.86
...
dmmd.lm0 <- lm(drymass_meandiff ~ temp + lux + imperv1000 +
               pol_abundance.yj + pol_richness + pol_shannon + 
               flo_abundance.yj + flo_richness + flo_shannon, data=RA_data)
summary(dmmd.lm0) # Adj-R2: -2.278; p: 0.998


# Best model with stepAIC()
step.dmmd.lm0 <- MASS::stepAIC(dmmd.lm0, direction = "both", trace = FALSE)
summary(step.dmmd.lm0) # Null is best
...
dmmo.lm.s6 <- lm(drymass_meanopen ~ pol_abundance.yj, data=RA_data)
summary(dmmo.lm.s6) # RSE: 0.006 ; Adj-R2: -0.087 ; p:: 0.84
...
dmmo.lm.s9 <- lm(drymass_meanopen ~ flo_abundance.yj, data=RA_data)
summary(dmmo.lm.s9) # RSE: 0.006 ; Adj-R2: -0.089 ; p:: 0.896
...
# -- Create multiple regression lm() models ----
dmmo.lm0 <- lm(drymass_meanopen ~ lux + imperv100 + # temp + 
               pol_abundance.yj + pol_richness + pol_shannon + # flo_shannon +
               flo_abundance.yj + flo_richness, data=RA_data)
summary(dmmo.lm0) # Adj-R2: -1.564; p: 0.978


# Best model with stepAIC()
step.dmmo.lm0 <- MASS::stepAIC(dmmo.lm0, direction = "both", trace = FALSE)
summary(step.dmmo.lm0) # RSE: 0.0056 ; Adj-R2: 0.1485 ; p:: 0.106
...
afmpsmd.lm.s6 <- lm(avgfremass_pseed_meandiff ~ pol_abundance.yj, data=RA_data)
summary(afmpsmd.lm.s6) # RSE: 0.0003 ; Adj-R2: -0.08 ; p:: 0.789
...
afmpsmd.lm.s9 <- lm(avgfremass_pseed_meandiff ~ flo_abundance.yj, data=RA_data)
summary(afmpsmd.lm.s9) # RSE: 0.0003 ; Adj-R2: -0.045 ; p:: 0.503 *
...
afmpsmd.lm0 <- lm(avgfremass_pseed_meandiff ~ temp + lux + imperv1000 +
                  pol_abundance.yj + pol_richness + pol_shannon + 
                  flo_abundance.yj + flo_richness + flo_shannon, data=RA_data)
summary(afmpsmd.lm0) # Adj-R2: -1.91; p: 0.993
...
afmpsmo.lm.s6 <- lm(avgfremass_pseed_meanopen ~ pol_abundance.yj, data=RA_data)
summary(afmpsmo.lm.s6) # RSE: 0.0004 ; Adj-R2: -0.06 ; p:: 0.61 *
...
afmpsmo.lm.s9 <- lm(avgfremass_pseed_meanopen ~ flo_abundance.yj, data=RA_data)
summary(afmpsmo.lm.s9) # RSE: 0.0004 ; Adj-R2: -0.06 ; p:: 0.59 *
...
afmpsmo.lm0 <- lm(avgfremass_pseed_meanopen ~ lux + imperv100 + # temp + 
                  pol_abundance.yj + pol_richness + pol_shannon + flo_shannon +
                  flo_abundance.yj + flo_richness, data=RA_data)
summary(afmpsmo.lm0) # Adj-R2: -1.09; p: 0.927


# Best model with stepAIC()
step.afmpsmo.lm0 <- MASS::stepAIC(afmpsmo.lm0, direction = "both", trace = FALSE)
summary(step.afmpsmo.lm0) # Adj-R2: 0.127; p: 0.2


# Check model's call
step.afmpsmo.lm0$call # ~ pol_shannon + flo_abundace.yj


# Check multi-collinearity
vif(step.afmpsmo.lm0) %>% 
  knitr::kable()
...
admpsmd.lm.s6 <- lm(avgdrymass_pseed_meandiff ~ pol_abundance.yj, data=RA_data)
summary(admpsmd.lm.s6) # RSE: 0.0002 ; Adj-R2: -0.09 ; p:: 0.986
...
admpsmd.lm.s9 <- lm(avgdrymass_pseed_meandiff ~ flo_abundance.yj, data=RA_data)
summary(admpsmd.lm.s9) # RSE: 0.0002 ; Adj-R2: -0.087 ; p:: 0.854
...
admpsmd.lm0 <- lm(avgdrymass_pseed_meandiff ~ lux + imperv100 + # temp + 
                  pol_abundance.yj + pol_richness + pol_shannon + # flo_shannon +
                  flo_abundance.yj + flo_richness, data=RA_data)
summary(admpsmd.lm0) # Adj-R2: -0.87; p: 0.93


# Best model with stepAIC()
step.admpsmd.lm0 <- MASS::stepAIC(admpsmd.lm0, direction = "both", trace = FALSE)
summary(step.admpsmd.lm0) # Adj-R2: 0.166; p: 0.092


# Check model's call
step.admpsmd.lm0$call # ~ imperv100
...
admpsmo.lm.s6 <- lm(avgdrymass_pseed_meanopen ~ pol_abundance.yj, data=RA_data)
summary(admpsmo.lm.s6) # RSE: 0.0003 ; Adj-R2: -0.08 ; p:: 0.785
...
summary(admpsmo.lm.s8) # RSE: 0.0002 ; Adj-R2: 0.2322 ; p:: 0.054 *

admpsmo.lm.s9 <- lm(avgdrymass_pseed_meanopen ~ flo_abundance.yj, data=RA_data)
summary(admpsmo.lm.s9) # RSE: 0.0003 ; Adj-R2: -0.09 ; p:: 0.987
...
admpsmo.lm0 <- lm(avgdrymass_pseed_meanopen ~ lux + imperv100 + # temp + 
                  pol_abundance.yj + pol_richness + pol_shannon + 
                  flo_abundance.yj + flo_richness + flo_shannon, data=RA_data)
summary(admpsmo.lm0) # Adj-R2: -0.516; p: 0.82
...
afmfs.lm.s6 <- lm(avgfremass_ferseed ~ pol_abundance.yj, data=RA_data)
summary(afmfs.lm.s6) # RSE: 0.0004 ; Adj-R2: -0.07 ; p:: 0.7 *
...
afmfs.lm.s9 <- lm(avgfremass_ferseed ~ flo_abundance.yj, data=RA_data)
summary(afmfs.lm.s9) # RSE: 0.00039 ; Adj-R2: -0.04 ; p:: 0.5131 *
...
# -- Create multiple regression lm() models ----
afmfs.lm0 <- lm(avgfremass_ferseed ~ lux + imperv100 + temp + 
                pol_abundance.yj + pol_shannon + pol_richness + flo_shannon +
                flo_abundance.yj + flo_richness, data=RA_data)
summary(afmfs.lm0) # Adj-R2: -0.644; p: 0.867


# Best model with stepAIC()
step.afmfs.lm0 <- MASS::stepAIC(afmfs.lm0, direction = "both", trace = FALSE)
summary(step.afmfs.lm0) # Adj-R2: 0.06 ; p: 0.288


# Check model's call
step.afmfs.lm0$call # ~ flo_abundance.yj + flo_shannon
...
admfs.lm.s6 <- lm(avgdrymass_ferseed ~ pol_abundance.yj, data=RA_data)
summary(admfs.lm.s6) # RSE: 0.0003 ; Adj-R2: -0.08 ; p:: 0.8588
...
admfs.lm.s9 <- lm(avgdrymass_ferseed ~ flo_abundance.yj, data=RA_data)
summary(admfs.lm.s9) # RSE: 0.0003 ; Adj-R2: -0.08 ; p:: 0.86
...
admfs.lm0 <- lm(avgdrymass_ferseed ~ lux + imperv100 + # temp + 
                pol_abundance.yj + pol_shannon + pol_richness + flo_shannon +
                flo_abundance.yj + flo_richness, data=RA_data)
summary(admfs.lm0) # Adj-R2: -0.1314; p: 0.6224


# Best model with stepAIC()
step.admfs.lm0 <- MASS::stepAIC(admfs.lm0, direction = "both", trace = FALSE)
summary(step.admfs.lm0) # Adj-R2: 0.4177; p: 0.0498


# Check model's call
step.admfs.lm0$call # ~ imperv100 + pol_richness + flo_shannon
...
# ~ imperv100 + pol_richness + flo_shannon
# Adj-R2: 0.4177; p: 0.0498
