...
ggplot(CF_data, aes(x = treatment, y = fruit_mass, fill = treatment)) +
  ...
  ggtitle("Capsicum | Fruit Mass: Pollination excluded (Bagged) < Open",
...
ggplot(CFF_data, aes(x = treatment, y = fruit_mass, fill = treatment)) +
  ...
  geom_jitter(color="black", size=0.6, alpha=0.9) +
  labs(x = "treatment", y = "Fruit Mass") +
  ggtitle("Capsicum | Fruit Mass ('outliers-removed'): Pollination excluded (Bagged) < Open ",
...
ggplot(CF_data, aes(x = treatment, y = seed_mass, fill = treatment)) +
  ...
  ggtitle("Capsicum | Seed Mass: Pollination excluded (Bagged) < Open",
