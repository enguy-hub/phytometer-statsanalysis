...
pred_r_squared(fmmo.lm1.init) # -0.267

# Interaction model
fmmo.lm1.inter <- stepAIC(fmmo_trans.lm1, ~.^2, trace=F) # Same as initial
...
summ(fmmo.lm2.init, digits= 4) # Same as fmmo.lm1.init
...
# Interaction model
fmmo.lm3.inter <- stepAIC(fmmo_trans.lm3, ~.^2, trace=F) # Same as initial

# ---------------------------------------------

# Model: Lux + Imperv100 + pol_sha
...
summ(fmmo.lm4.init, digits= 4) # Same as fmmo.lm3.init

# Interaction model
fmmo.lm4.inter <- stepAIC(fmmo_trans.lm4, ~.^2, trace=F) # Same as initial
summ(fmmo.lm4.inter, digits= 4) # Same as fmmo.lm3.init

# ---------------------------------------------

# Model: Lux + Imperv100 + pol_sha.yj
...
summ(fmmo.lm5.init, digits= 4) # Same as fmmo.lm3.init

# Interaction model
fmmo.lm5.inter <- stepAIC(fmmo_trans.lm5, ~.^2, trace=F) # Same as initial
summ(fmmo.lm5.inter, digits= 4) # Same as fmmo.lm3.init
...
summ(smmo_trans.lm1.inter,digits=4) # Same as smmo_trans.lm0.init
...
summ(smmo_trans.lm2.inter,digits=4) # Same as smmo_trans.lm2.init
...
summ(smmo_trans.lm3.inter,digits=4) # Same as smmo_trans.lm3.init
...
summ(smmo_trans.lm4.inter,digits=4) # Same as smmo_trans.lm4.init
...
summ(smmo_trans.lm5.inter,digits=4) # Same as smmo_trans.lm5.init
